...
public interface AuthorizationEndpointImpl {
    ...
    @WebMethod
    @Action(input = "http://endpoint.projectmanager.dragard.org/AuthorizationEndpointImpl/loginRequest", output = "http://endpoint.projectmanager.dragard.org/AuthorizationEndpointImpl/loginResponse")
